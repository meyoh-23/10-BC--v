...
const LeaderCard = ({name, role, image}) => {
  return (
    <article className="my-4 mx-2 flex flex-col ss:flex-row gap-2 items-center rounded-br-2xl w-[90%] ss:max-w-[350px] justify-between overflow-x-hidden shadow-2xl z-10 shadow-indigo-500/50">
