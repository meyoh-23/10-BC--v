...
const ActivityCard = ({ title, date, descritpion, image }) => {
  return (
    <article className="flex flex-col gap-3 shadow-2xl p-2 rounded-b-lg">
        ...
        <div className="max-w-sm mx-auto p-2 rounded-md shadow-lg z-10 flex flex-center justify-between items-end gap-4">
            ...
            <button className="p-2 bg-bgButtonSecondary text-white rounded-md text-p text-center font-raleway font-bold">View Gallary</button>
        </div>
    </article>
  )
}
